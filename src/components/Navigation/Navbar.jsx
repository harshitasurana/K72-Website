    ...
    return (
        <div className='flex fixed top-0 z-4 w-full items-start justify-between'>
            ...
            <div onClick={()=>{
                ...
                className='lg-h-15 h-12 bg-black relative lg-w-[18vw] w-80'>

                <div ref={navGreenRef} className='absolute top-0 bg-[#D3FD50]  h-0 w-full transition-all '></div>
                <div className='relative flex flex-col gap-2 justify-center items-end h-full px-10'>
